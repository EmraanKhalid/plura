    ...
    const handleClickEdit = async () =>{
        setOpen(
            <CustomModal title='Update Ticket Details' subheading=''>
                <TicketForm getNewTicket={editNewTicket}
        ...
        <Draggable draggableId={ticket.id.toString()} index={index}>
            {
                (provided, snapshot) => {
                    ...
                    return (<div
                        ...
                        <AlertDialog>
                            <DropdownMenu>
                                <Card className='my-4 dark:bg-slate-900 bg-white shadow-none
                            transition-all'>
                                    <CardHeader className='p-[12px]'>
                                        ...
                                        <HoverCard>
                                            <HoverCardTrigger asChild>
                                                ...
                                                hover:bg:muted transition-all rounded-lg
                                                ...
                                                <div className="flex justify-between space-x-4">
                                                    ...
                                                    <div className='space-y-1'>
                                                        ...
                                                        <div className='flex items-center pt-2'>
                                                            <Contact2 className='mr-2 h-4 2-4 opacity-70'/>
                                    ...
                                    <CardFooter className='m-0 p-2 border-t-[1px] border-muted-foreground/20
                                        ...
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <div className='flex flex-col justify-center'>
                                                ...
                                                {ticket.assignedUserId && (
                                                    <span className='text-xs w-28 overflow-ellipsis
                                                    overflow-hidden whitespace-nowrap text-muted-foreground'>
                                                        {ticket.Assigned?.name}
                                                    </span>
                                                )}
                                            </div>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>This action can no be undone. This will permanently
