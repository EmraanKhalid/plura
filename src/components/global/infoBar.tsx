    ...
    const handleClick = () =>{
        if(!showAll){
            ...
            if(notifications?.length !== 0){
                setAllNotifications(notifications?.filter((item)=>item.subAccountId ===
                 subAccountId) ?? []
                )
            }
        }
        ...
        <>
            ...
            >
                <div className='flex items-center gap-2 ml-auto'>
                    ...
                    <Sheet>
                        <SheetTrigger>
                            <div className='rounded-full w-9 h-9 bg-primary itmes-center flex
                        ...
                        <SheetContent className='mt-4 mr-4 pr-4 flex flex-col'>
                            ...
                            {allNotifications?.map((notification)=>(
                                <div key={notification.id} className='flex flex-col gap-y-2 mb-2 
                                overflow-x-scroll text-ellipsis'>
